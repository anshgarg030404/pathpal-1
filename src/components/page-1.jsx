    ...
    return(
        <div className=" pb-15 p-5 space-y-8 sm:px-40">
            ...
            <div className="flex justify-center">
                <button onClick={()=>{window.location.href='https://pathpal-1.netlify.app'}}
                 className="h-16 flex justify-evenly items-center bg-blue-500 py-1 px-2 w-auto  rounded-2xl space-x-3 ">
